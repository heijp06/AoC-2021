...
adm = Avidemux()
if not adm.loadVideo("C:/MyWork/MyWork/AdventOfCode/2021/day05/img/img00000000.jpg"):
    raise("Cannot load C:/MyWork/MyWork/AdventOfCode/2021/day05/img/img00000000.jpg")
adm.clearSegments()
adm.addSegment(0, 0, 21600000)
adm.markerA = 0
adm.markerB = 21600000
adm.setPostProc(3, 3, 0)
adm.videoCodec("x264", "useAdvancedConfiguration=True", "general.params=2PASSBITRATE=10000", "general.threads=0", "general.preset=ultrafast", "general.tuning=none", "general.profile=baseline", "general.fast_decode=False", "general.zero_latency=False"
